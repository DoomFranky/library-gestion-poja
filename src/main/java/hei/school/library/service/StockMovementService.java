...
public class StockMovementService {
    ...
    public StockMovement addStockMovement(StockMovementRequest stockMovementToPut) {
        ...
        StockMovement stockMovement = stockMovementMapper.stockMovementRequestToStockMovement(stockMovementToPut);
    ...
    public StockMovement getStockMovementById(String id) {
        ...
        return stockMovementRepository.findById(id).orElseThrow(() -> new NotFoundException("stockMovement not found"));
    }
